...
bool custom_msgs__msg__agent_target_destinations__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._agent_target_destinations.AgentTargetDestinations", full_classname_dest, 66) == 0);
  }
  custom_msgs__msg__AgentTargetDestinations * ros_message = _ros_message;
  {  // agents
...
{
  /* NOTE(esteve): Call constructor of AgentTargetDestinations */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._agent_target_destinations");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AgentTargetDestinations");

...
#ifndef CUSTOM_MSGS__MSG__DETAIL__ROBOT_COMMUNICATION__FUNCTIONS_H_
#define CUSTOM_MSGS__MSG__DETAIL__ROBOT_COMMUNICATION__FUNCTIONS_H_
 ...
 * calls
 * custom_msgs__msg__RobotCommunication__init().
...
/**
 * It calls
 * custom_msgs__msg__RobotCommunication__fini()
 ...
 * custom_msgs__msg__RobotCommunication__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_msgs__msg__RobotCommunication__Sequence__fini()
 * on the array,
...
#endif  // CUSTOM_MSGS__MSG__DETAIL__ROBOT_COMMUNICATION__FUNCTIONS_H_

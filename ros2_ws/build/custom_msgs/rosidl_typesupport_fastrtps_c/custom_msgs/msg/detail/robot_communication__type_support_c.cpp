...
#include "custom_msgs/msg/detail/robot_communication__rosidl_typesupport_fastrtps_c.h"
...
using _RobotCommunication__ros_msg_type = custom_msgs__msg__RobotCommunication;
...
size_t get_serialized_size_custom_msgs__msg__RobotCommunication(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotCommunication__ros_msg_type * ros_message = static_cast<const _RobotCommunication__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RobotCommunication__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__RobotCommunication(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__RobotCommunication(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__RobotCommunication;
    is_plain =
      (
...
static size_t _RobotCommunication__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__RobotCommunication(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, RobotCommunication)() {

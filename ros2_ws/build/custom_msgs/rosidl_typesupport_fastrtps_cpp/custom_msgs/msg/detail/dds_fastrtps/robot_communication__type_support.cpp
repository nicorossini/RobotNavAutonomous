...
#include "custom_msgs/msg/detail/robot_communication__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::RobotCommunication & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::RobotCommunication & ros_message)
{
  // Member: robot_id
  cdr >> ros_message.robot_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::msg::RobotCommunication;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::RobotCommunication *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::RobotCommunication *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_RobotCommunication__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, RobotCommunication)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_RobotCommunication__handle;
}
